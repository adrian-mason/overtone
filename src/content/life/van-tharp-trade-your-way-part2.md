---
title: "Stop Predicting. Start Expecting."
subtitle: "Reading Notes · Trade Your Way to Financial Freedom — Part Two"
zh_title: "放弃预测，拥抱期望值"
...
如果第一部分是一场向内的审视，那么第二部分便是一次向外的转身——朝向市场、概率，以及交易系统的结构性架构。但请不要将"向外"误解为回归常规。撒普没有递给你一套指标、一个图表形态，或某种专有的入市信号。他给你的东西更经久、也更高要求：一个从底层逻辑出发，思考交易系统的框架。

第二部分的核心论点可以清晰地表述如下：盈利交易者与亏损交易者之间的差距，不在于谁的市场预测更准确，而在于各自系统的数学结构——具体而言，是这个系统在大样本交易中能否产生正的期望收益，以及交易者能否在此期间存活足够长的时间，让数学规律得以发挥作用。

---

## 一、构建系统：在数据之前，先立纪律

第四章开篇便提出了一个批评，任何在网络交易社区待过一段时间的人都会会心一笑：所谓"系统开发"的惯常做法，是找几个在历史数据上看起来不错的技术指标，将它们组合成一条入市规则，然后宣告系统完成。撒普认为这不是系统开发，而是把曲线拟合包装成了方法论。

真正严谨的系统开发，需要遵循一套有顺序的纪律：

**从盘点自身开始，而非从指标开始**。在打开第一张图表之前，你必须对自己的资本、可用时间、技术技能，以及第二章已经识别出的心理弱点，有一个诚实的评估。没有这个基础建立起来的系统，迟早会被放弃——不是因为它停止了盈利，而是因为它从来就不适合使用它的那个人。

**先定时间框架与理念，再谈系统设计**。长期投资者、波段交易者和日内交易者不是可以随意互换的身份。每一种都对注意力、隔夜风险敞口和波动率的容忍度提出了截然不同的要求。这个选择必须先于系统设计，而非在其之后。

**在一切之前，定义好 1R**。一笔交易的初始风险——如果价格立即向你不利的方向运动，你愿意承受的确切亏损金额——不是一个可以事后添加的细节。它是整个系统围绕其组织的计量单位。此后所有内容，包括盈利目标、头寸规模，以及绩效评估，都以这个数字的倍数来表达。

**为最坏的情形做好压力测试**。一个系统在你从心理上演练过可能摧毁它的场景之前，是不完备的：交易所关闭、隔夜跳空、地缘政治冲击、流动性危机。如果你在这些事件发生之前没有想清楚应对方案，当它们真正发生时，你的反应必然是混乱的。

---

## 二、理念：支撑每笔交易背后的逻辑

第五章提出了一个既显而易见、又被反复忽视的观点：不存在唯一正确的交易方式。任何方法都可以奏效，只要它能产生正的期望收益，并且与执行它的人的性格相匹配。匹配性不是盈利能力的附属品——它是盈利能力的前提条件。

撒普梳理了几种经受住时间检验的主要交易理念：

**趋势跟踪**是与"截断亏损、让利润滚动"这一原则联系最紧密的方法。它的胜率通常低于 50%，有时远低于此。从事这一策略的人必须在心理上做好准备，能够承受一段段连续的小额亏损，同时保持耐心，等待偶尔出现的那笔大收益来验证整套策略的合理性。其中有一条铁律：绝不错过任何一次重大的市场移动。一个趋势跟踪者因为觉得某次设置看起来不够确定而回避了交易，就已经动摇了这个方法的数学根基。

**基本面与价值交易**运行在不同的逻辑上：分析供需关系，或识别出正以显著折扣于内在价值成交的资产，然后等待市场纠正这一错误定价。这里最关键的纪律在于入场的耐心——具体而言，要等到有证据表明下跌趋势已经结束，再动用资金，而不是仅仅凭借估值便宜就去接一把下落中的刀。

**波段交易**利用的是市场像橡皮筋一样偏离均衡后回归的特性。它在震荡市中尤为有效，适合偏好较高胜率和更频繁操作节奏的交易者。其风险在于：一旦市场进入单边趋势行情，若管理不当，可能会将许多次成功的震荡交易所积累的盈利一次性吃掉。

此外，撒普还介绍了季节性规律、跨市分析（汇率、商品与股市之间的联动关系），以及套利与价差交易——这些方法需要更专业的知识积累，但对于愿意深耕的人，确实能提供真实的优势。

---

## 三、用宏观视角看清你所处的坐标

第六章直面了一个令人清醒的现实：没有任何系统能在所有市场环境下永远有效。一套在某种环境中完美校准的策略，在另一种环境中可能从结构上就不适用。那些能够在数十年间保持稳定表现的交易者，靠的不是最好的入市信号，而是对自己的系统所处的宏观背景有清醒的认知，并能据此做出相应调整。

撒普识别出几种任何严肃投资者都必须纳入框架的结构性力量：

**长期估值周期**。股市的运行存在跨越数十年的大周期，驱动力主要来自市盈率的扩张与收缩，而后者又与通货膨胀和紧缩的动态密切相关。当估值已经拉伸、通胀开始抬头，历史经验表明，未来十年乃至二十年股票的实际回报往往很差——有时甚至是深度负值。在这一背景下忽视估值、追逐短期动量，并非看多，而是对基础成功率的无知。

**商品周期与新兴市场的崛起**。大型发展中国家的工业化进程，为原材料和能源创造了持续的结构性需求——这一动态以年和十年为单位演进，而非以季度计。撒普在这一章的具体分析反映了他写作的那个时代背景，但其底层原则——宏观人口与经济转型会在资产类别中创造长周期趋势——至今仍具有指导意义。

**机构持仓的结构性压力**。发达经济体的股市长期受到战后婴儿潮一代积累退休储蓄的支撑。当这一代人从积累阶段过渡到提取阶段——从基金申购者变为赎回者——数十年来支撑市场的结构性需求将发生根本性转变。这个转变的时机尚存不确定性，但其最终影响并不存疑。

这些分析的实践意义，并非要回避股票或盲从某种宏观叙事，而是要明确地为特定市场环境设计系统，并对"支撑我这套系统的条件，当下是否成立"这个问题保持持续的清醒。

---

## 四、打雪仗：期望收益，一切的底层逻辑

第七章是全书的数学核心，也是让其他所有内容得以贯通的关键洞见。撒普用一个打雪仗的比喻来引入这个概念——简单到令人印象深刻，精确到足以实用。

设想两支队伍在打雪仗。白色雪球得分，黑色雪球失分。最终结果取决于六个变量：防守雪墙的大小（资本规模）、白色与黑色雪球的比例（胜率）、两种雪球的相对大小（盈利与亏损的 R 乘数分布）、每个雪球对雪墙的损耗程度（交易成本）、雪球投出的频率（交易机会），以及每次同时投出的雪球数量（头寸规模）。

这六个变量分别对应交易系统设计的一个核心组件。但最关键的洞见在于胜率与雪球大小之间的相互作用——而它颠覆了几乎所有新手的直觉。

**一个胜率高达 90% 的系统，完全可以具有负的期望收益**。如果每次盈利赚取 1R，而每次亏损损失 10R，那么这个系统在足够多的交易之后，必然亏钱——尽管它十次有九次是赢的。反过来，一个只有 35% 胜率的系统，如果平均盈利交易达到 3R 或 4R，而平均亏损只有 1R，则完全可以高度盈利。**期望收益——所有交易 R 乘数的平均值——才是决定一个系统长期赚钱还是亏钱的核心指标。**

这不是一个边角性的洞见。它是对大多数人思考交易方式的正面挑战。对胜率的执着、对"预测正确"的渴望、对高概率入市机会的追逐——如果对这些的追求没有伴随着对它们所产生的 R 乘数分布的理解，那么这一切都是徒劳的。

期望收益的计算方式并不复杂：将每种可能的 R 乘数结果乘以其发生概率，然后求和。结果为正，意味着系统在足够多的交易样本中能赚钱；结果为负，意味着无论底层逻辑看起来多么精妙，它终将亏损。

**交易频率，将期望收益的效果双向放大**。一个期望收益略正但交易频率极高的系统，可以产生相当可观的回报。一个期望收益为负且频率极高的系统，则会迅速摧毁资本。这正是做市商——依靠微小优势但庞大交易量运作——能够成为市场中最持续盈利的参与者之一的原因。

**头寸规模，是将期望收益转化为实际结果的最后一道工序**。一个具有真实正期望收益的系统，如果头寸规模管理失当，依然会走向破产——不是因为优势不存在，而是因为不可避免的连亏期间的波动幅度，超出了资本所能承受的边界。反之，若头寸规模的设定同时考量了期望收益与系统的波动性，交易者便能在熬过那些连亏序列的同时，最终收获系统所拥有的数学优势。

---

## 结语

《通向财务自由之路》第二部分，重新定义了"拥有一套投资策略"意味着什么。一套策略不是关于市场走向的一组信念，而是一个具有可测量统计属性的系统——一个有明确 R 乘数分布的系统、一个可以计算的期望收益、一个头寸规模与生存概率之间清晰的数量关系。这些属性可以被估算、被测试、被改进。而市场预测做不到这些。

撒普在这里传授的纪律并不轻松，也不令人热血沸腾。但它是可重复的。而从长期来看，可重复的优势以复利积累的方式增长，这是直觉和预测永远无法企及的。

---

*本文为系统研读范·K·撒普博士著作的阅读笔记，涵盖第二部分第 4—7 章。*
